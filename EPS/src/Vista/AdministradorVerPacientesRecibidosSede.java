 ...
 * @author ediso
 */
public class AdministradorVerPacientesRecibidosSede extends javax.swing.JInternalFrame {
    ...
    public AdministradorVerPacientesRecibidosSede() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable_paciente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Cita", "Id Paciente", "Diagnostico", "Fecha Hora", "Id Medico", "Especialidad", "Sede"
            }
        ));
        ...
        jComboBoxSede.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Bogota", "Medellin", "Cali", "Barranquilla", "Ibague" }));
        jComboBoxSede.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBoxSedeActionPerformed(evt);
            }
        });
        jPanel2.add(jComboBoxSede, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 110, -1));
        ...
        jComboBoxTipo1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Urgencia", "Medicina General", "Especialidades" }));
        jComboBoxTipo1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBoxTipo1ActionPerformed(evt);
            }
        });
        jPanel2.add(jComboBoxTipo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 110, -1));
