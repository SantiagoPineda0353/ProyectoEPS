...
import Vista.Actualizarpaciente_adminpaciente;
 ...
 * @author MRoblesDev
 */
public class Ctrlconsultarpaciente implements ActionListener {

    private final Producto modelo;
    private final ConsultasProducto consultas;
    private final frmProducto vista;

    public Ctrlconsultarpaciente(Producto modelo, ConsultasProducto consultas, frmProducto vista) {
        this.modelo = modelo;
